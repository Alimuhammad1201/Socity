                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_7" name="invoice" value="1">
                                                    ...
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_12" name="payroll" value="1">
                                                    ...
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_14" name="leave" value="1">
