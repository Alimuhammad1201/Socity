                    ...
                    <div class="card border-top  border-white">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Parking Edit</h5>
                            </div>
                            <hr>
                            ...
                            <form class="row g-3" action="{{ route('parking.update',$parking->id) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="allotment_id" name="allotment_id">
                                        ...
                                        @foreach($allotments as $row)
                                            <option value="{{ $row->id }}"{{$row->id == $parking->allotment_id ?'selected':''}}>{{ $row->OwnerName }}</option>
                                        @endforeach
                                    </select>
                                    @error('allotment_id')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="parking_space_number" name="parking_space_number"
                                           placeholder="Parking Space Number" value="{{ old('parking_space_number',$parking->parking_space_number) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="vehicle_number" name="vehicle_number"
                                           placeholder="Vehicle Number" value="{{ old('vehicle_number',$parking->vehicle_number) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="parking_status" name="parking_status">
                                        ...
                                        <option value="pending" {{ old('parking_status',$parking->parking_status)=='pending' ? 'selected' : '' }}>Pending
                                        </option>
                                        <option value="confirmed" {{ old('parking_status',$parking->parking_status)=='confirmed' ? 'selected' : '' }}>Confirmed
                                        </option>
                                        <option value="cancelled" {{ old('parking_status',$parking->parking_status)=='cancelled' ? 'selected' : '' }}>Cancelled
                                        </option>
                                    </select>
