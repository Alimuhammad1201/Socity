                    ...
                    <div class="card border-top  border-white">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Car Stickers Add</h5>
                            </div>
                            <hr>
                            ...
                            @endif
                            <form class="row g-3" action="{{ route('carsticker.store') }}" method="POST">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="car_number" name="car_number"
                                           placeholder="Service Name" value="{{ old('car_number') }}">
                                    @error('car_number')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="sticker_id" name="sticker_id"
                                               placeholder="Service Name" value="{{ old('sticker_id') }}">
                                        @error('sticker_id')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="issue_date" name="issue_date"
                                               placeholder="Service Name" value="{{ old('issue_date') }}">
                                        @error('issue_date')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="expiry_date" name="expiry_date"
                                               placeholder="Service Name" value="{{ old('expiry_date') }}">
                                        @error('expiry_date')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="charges" name="charges"
                                               placeholder="Service Name" value="{{ old('charges') }}">
                                        @error('charges')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option
                                                value="Duplicate" {{ old('status')=='Duplicate' ? 'selected' : '' }}>
                                                Duplicate
                                            </option>
