            ...
            <div class="col-xl-9 mx-auto ">
                ...
                <div class="card border-top  border-white">
                    <div class="card-body p-5">
                        ...
                        <form class="row g-3" action="{{ route('document.update', $docs->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="document_name" name="document_name" value="{{$docs->document_name}}" placeholder="Document Name">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="document_type" name="document_type" value="{{$docs->document_type}}" placeholder="Document Type">
