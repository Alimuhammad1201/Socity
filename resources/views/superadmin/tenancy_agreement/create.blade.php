                    ...
                    <div class="card border-top  border-white">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Tenancy Agreement Add</h5>
                            </div>
                            <hr>
                            ...
                            <form class="row g-3" action="{{ route('tenancy.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" id="agreement_pdf" name="agreement_pdf"
                                           placeholder="Agreement PDF" accept="application/pdf" value="{{ old('agreement_pdf') }}">
                                    @error('agreement_pdf')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
