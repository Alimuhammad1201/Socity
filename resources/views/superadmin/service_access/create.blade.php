                    ...
                    <div class="card border-top  border-white">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Service Access Add</h5>
                            </div>
                            <hr>
                            ...
                            @endif
                            <form class="row g-3" action="{{ route('service_access.store') }}" method="POST">
                                @csrf
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="access_status" name="access_status">
                                        ...
                                        <option value="pending" {{ old('access_status')=='pending' ? 'selected' : '' }}>Pending
                                        </option>
                                        <option value="confirmed" {{ old('access_status')=='confirmed' ? 'selected' : '' }}>Confirmed
                                        </option>
                                        <option value="cancelled" {{ old('access_status')=='cancelled' ? 'selected' : '' }}>Cancelled
                                        </option>
                                    </select>
                                    @error('access_status')
                                    <div class="text-danger">{{ $message }}</div>
