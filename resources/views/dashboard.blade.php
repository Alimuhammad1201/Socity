                            ...
                            <div class="row row-cols-1 row-cols-sm-3 mt-4">
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <p class="mb-0 font-13"><i class='bx bxs-up-arrow align-middle'></i> For The
                                            Month August 2024</p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <p class="mb-0 font-13"><i class='bx bxs-up-arrow align-middle'></i> On 15th
                                            August</p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div>
                                        ...
                                        <p class="mb-0 font-13"><i class='bx bxs-down-arrow align-middle'></i> Total For
                                            Last August 2024</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table align-middle mb-0 table-hover">
                                    ...
                                    @foreach ($complaints as $row )
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    class="badge rounded-pill bg-light text-white w-100">{{$row->status}}</div>
                                            </td>
                        ...
                        <div class="card radius-10 w-100">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                    Unresolved<span class="badge bg-light-white-2 rounded-pill">{{$unresolved}}</span>
                                </li>
                                <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                    In-Progress<span class="badge bg-light-white-3 rounded-pill">{{$inProgress}}</span>
                                </li>
                                <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                    Resolved<span class="badge bg-white rounded-pill text-dark">{{$resolved}}</span>
                                </li>
                                <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                    All Complaints <span
                                        class="badge bg-light-white-4 text-white rounded-pill">{{$total}}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
