...
use App\Http\Controllers\Admin\Building_AdminController;
use App\Http\Controllers\BuildingAdminLoginController;
...
Route::post('/building_admin/login', [BuildingAdminLoginController::class, 'AdminLogin'])->name('building_admin.login');
Route::post('/building_admin/logout', [BuildingAdminLoginController::class, 'AdminLogout'])->name('building_admin.logout');
Route::group(['middleware' => ['auth:building_admin']], function () {
    Route::get('/building_admin/dashboard', [BuildingAdminLoginController::class, 'AdminDashboard'])->name('building_admin.dashboard');
});
Route::group(['middleware' => ['buildings']], function() {
Route::controller(PackageController::class)->group(function () {
    Route::get('/packages', 'index')->name('packages.index');
    Route::get('/package', 'backendindex')->name('packages.backendindex');
    ...
    Route::get('/packages/delete/{id}', 'destroy')->name('packages.destroy');
});
});
Route::group(['middleware' => ['buildings']], function() {
    Route::controller(BuildingController::class)->group(function () {
        Route::get('/admin/building', 'index')->name('building.index');
        Route::get('/admin/building/create', 'create')->name('building.create');
        Route::post('/building/create', 'store')->name('building.store');
        Route::get('/building/edit/{id}', 'edit')->name('building.edit');
        Route::post('/building/update/{id}', 'update')->name('building.update');
        Route::get('/building/delete/{id}', 'destroy')->name('building.destroy');
    });
});
Route::group(['middleware' => ['buildings']], function() {
Route::controller(Building_AdminController::class)->group(function () {
    Route::get('/admin-building', 'index')->name('admin-building.index');
    Route::get('/admin-building/create', 'create')->name('admin-building.create');
    Route::post('/admin-building/store', 'store')->name('admin-building.store');
    Route::get('/admin-building/edit/{id}', 'edit')->name('admin-building.edit');
    Route::post('/admin-building/update/{id}', 'update')->name('admin-building.update');
    Route::get('/admin-building/delete/{id}', 'destroy')->name('admin-building.destroy');
});
});
...
Route::middleware(['buildings'])->group(function () {
    Route::controller(BlockController::class)->group(function () {
        Route::get('/block', 'index')->name('block.index');
